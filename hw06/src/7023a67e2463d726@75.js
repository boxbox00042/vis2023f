...
function _artistPubilc(FileAttachment){return(
...
function _artistpublic_columnKey(artistPubilc){return(
Object.keys(artistPubilc [0])[4]
)}

function _artistpublic_Column(artistPubilc,artistpublic_columnKey){return(
artistPubilc.map(row => String(row[artistpublic_columnKey]))
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("artistPubilc")).define("artistPubilc", ["FileAttachment"], _artistPubilc);
  ...
  main.variable(observer("artistpublic_columnKey")).define("artistpublic_columnKey", ["artistPubilc"], _artistpublic_columnKey);
  main.variable(observer("artistpublic_Column")).define("artistpublic_Column", ["artistPubilc","artistpublic_columnKey"], _artistpublic_Column);
